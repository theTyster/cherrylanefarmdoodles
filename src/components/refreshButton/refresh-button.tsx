/**
 * This component displays a refresh button, which when clicked, calls an asynchronous function.
 **/
export default function RefreshButton<T>({
  refreshAction,
  refreshWhat,
}: {
